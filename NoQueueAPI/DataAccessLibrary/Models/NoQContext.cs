...
public partial class NoQContext : ApplicationDBContext
{
    ...
    public virtual DbSet<BranchTables> BranchTables { get; set; }
    public virtual DbSet<Transaction> Transactions { get; set; }
    public virtual DbSet<BranchOrders> BranchOrders { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BranchOrders>(entity =>
        {
            entity.ToTable("BranchOrders");
        ...
        modelBuilder.Entity<BranchTables>(entity =>
        {
            entity.ToTable("BranchTables");
            entity.Property(e => e.TableId).ValueGeneratedOnAdd();
            entity.Property(e => e.IsTakeAway).HasDefaultValueSql("((0))");
            entity.Property(e => e.IsActive).HasDefaultValueSql("((1))");
            entity.Property(e => e.IsDeleted).HasDefaultValueSql("((0))");
            entity.Property(e => e.CreatedDate).HasDefaultValueSql("GETDATE()");
        ...
        {
            e.HasKey("Id");
            e.ToTable("AspNetUserClaims"); // Use the actual table name
        });
       ...
       /* modelBuilder.Entity<IdentityRole<string>>(e =>
        {
            e.HasKey("Id");
            e.ToTable("AspNetRoles"); // Use the actual table name
        });*/
       ...
       /* modelBuilder.Entity<IdentityUser<string>>(e =>
        {
            e.ToTable("AspNetUsers"); // Use the actual table name
        });*/
...
*/            entity.Property(e => e.AccountHolderName).HasMaxLength(100);
            ...
            entity.Property(e => e.BankDetailId).ValueGeneratedOnAdd();
            entity.Property(e => e.IsActive).HasDefaultValueSql("((1))");
            entity.Property(e => e.IsDeleted).HasDefaultValueSql("((0))");
            entity.Property(e => e.CreatedDate).HasDefaultValueSql("GETDATE()");
...
.ValueGeneratedOnAdd();
        ...
        modelBuilder.Entity<CompanyMaster>(entity =>
        {
         ...
         .HasDefaultValueSql("(getdate())");
            ...
            entity.Property(e => e.Remarks).HasMaxLength(500);
            entity.Property(e => e.StatusUpdatedDate).HasColumnType("datetime");
            entity.Property(e => e.IsRegisteredVerified)
        ...
        modelBuilder.Entity<FoodCategory>(entity =>
        {
            ...
            entity.Property(e => e.Browser).HasMaxLength(100);
            entity.Property(e => e.CreatedDate).HasColumnType("datetime");
            entity.Property(e => e.FoodCategoryImage).HasMaxLength(512);
            entity.Property(e => e.Ipaddress)
                .HasMaxLength(100)
                .HasColumnName("IPAddress");
            entity.Property(e => e.ModifiedDate).HasColumnType("datetime");
        ...
        modelBuilder.Entity<FoodItem>(entity =>
        {
            ...
            entity.Property(e => e.FoodItemId).ValueGeneratedOnAdd();
            entity.Property(e => e.IsActive).HasDefaultValueSql("((1))");
            entity.Property(e => e.IsDeleted).HasDefaultValueSql("((0))");
            entity.Property(e => e.CreatedDate).HasDefaultValueSql("GETDATE()");
            entity.Property(e => e.Browser).HasMaxLength(100);
        ...
        modelBuilder.Entity<FoodSubCategory>(entity =>
        {
            ...
            entity.Property(e => e.FoodSubCategoryId).ValueGeneratedOnAdd();
            entity.Property(e => e.IsActive).HasDefaultValueSql("((1))");
            entity.Property(e => e.IsDeleted).HasDefaultValueSql("((0))");
            entity.Property(e => e.CreatedDate).HasDefaultValueSql("GETDATE()");
            entity.Property(e => e.Browser).HasMaxLength(100);
        ...
        modelBuilder.Entity<PhotoCategoryMaster>(entity =>
        {
            ...
            entity.Property(e => e.PhotoCategoryId).ValueGeneratedOnAdd();
            entity.Property(e => e.IsActive).HasDefaultValueSql("((1))");
            entity.Property(e => e.IsDeleted).HasDefaultValueSql("((0))");
            entity.Property(e => e.CreatedDate).HasDefaultValueSql("GETDATE()");
    ...
    private static void SeedRoles(ModelBuilder builder)
    {
        builder.Entity<IdentityRole>().HasData
            ...
            new IdentityRole() { Name = "Branch Head", ConcurrencyStamp = "4", NormalizedName = "BranchHead" },
            new IdentityRole() { Name = "Cashier", ConcurrencyStamp = "5", NormalizedName = "Cashier" },
            new IdentityRole() { Name = "Kitchen Supervisor", ConcurrencyStamp = "6", NormalizedName = "KitchenSupervisor" },
            new IdentityRole() { Name = "Steward", ConcurrencyStamp = "7", NormalizedName = "Steward" }

            );
        builder.Entity<StatusMaster>().HasData(
            new StatusMaster()
            {
                StatusId=1,
                Name="Active",
        ...
        builder.Entity<PhotoCategoryMaster>().HasData(
           new PhotoCategoryMaster()
           {
               Id = 1,
               PhotoCategoryId = 1,
               CategoryName = "Branch",
